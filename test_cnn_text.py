...
x_test, vocab_processor = data_preprocess.text_to_onehot(x_seg)
checkpoint_dir = "runs/1525180813/checkpoints/"
...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        batches = data_preprocess.batch_iter(list(x_test), batch_size, num_epochs=1, shuffle=False)
